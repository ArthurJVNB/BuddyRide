...
public class Facade {
    ...
    public boolean checkUserSecretAnswer(String userId, String secretQuestion, String secretAnswer) throws UserControllerException {
        return mUserController.checkSecretAnswer(userId, secretQuestion, secretAnswer);
    }
